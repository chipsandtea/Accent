Stanford Lexicalized Parser v2.0.1 - 2012-03-09
------------------------------------------------
...
Browse, and select the models jar same directory.  From the models
jar, select englishPCFG.ser.gz.  Click Parse to parse the first
sentence.
...
Version 2.0.1  2012-03-09
   Caseless English model added, ready for maven
Version 2.0.0  2012-01-11
   Threadsafe!
